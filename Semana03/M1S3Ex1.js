...
const usernameProcurado = "Eladio66";

const usuarioEncontrado = listaJSON.find(
  (usuario) => usuario.username === usernameProcurado
);
...
if (usuarioEncontrado) {
  ...
  console.log(`Não foi encontrado usuário com o username ${usernameProcurado}`);
}
